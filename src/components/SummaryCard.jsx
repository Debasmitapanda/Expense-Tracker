...
export default function SummaryCard({ 
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 p-3 sm:p-4 bg-white/95 backdrop-blur-md border-t border-emerald-100 shadow-[0_-8px_30px_rgba(0,0,0,0.12)] transition-all">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="w-full md:w-auto flex items-center justify-between md:justify-start gap-4 sm:gap-6">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-500 text-white flex items-center justify-center shadow-md shadow-emerald-600/30 gpay-glow shrink-0">
              ...
              <div>
                ...
                <div className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight leading-none mt-0.5">
            ...
            <div className="hidden xs:flex flex-col gap-1 border-l border-slate-200 pl-4">
              <div className="flex items-center space-x-1.5 text-xs font-semibold text-slate-600">
                ...
                <span>Online:</span>
                <span className="font-bold text-slate-900">₹{onlineTotal.toLocaleString('en-IN')}</span>
              </div>
              <div className="flex items-center space-x-1.5 text-xs font-semibold text-slate-600">
                <span className="w-2 h-2 rounded-full bg-amber-500"></span>
                <span>Cash:</span>
                <span className="font-bold text-slate-900">₹{cashTotal.toLocaleString('en-IN')}</span>
              </div>
              {withdrawTotal > 0 && (
                <div className="flex items-center space-x-1.5 text-[11px] font-semibold text-blue-700 bg-blue-50 px-2 py-0.5 rounded-md">
                  <Building2 className="w-3 h-3 text-blue-600" />
                  <span>Withdraw:</span>
                  <span className="font-bold">₹{withdrawTotal.toLocaleString('en-IN')}</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="w-full md:w-auto flex items-center justify-end space-x-2.5">
            ...
            <button
              ...
              className={`px-3.5 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center space-x-1.5 ${
                totalEntriesCount > 0
            ...
            <button
              ...
              className="flex-1 md:flex-none px-5 py-2.5 rounded-2xl text-xs font-extrabold text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 shadow-md shadow-emerald-600/25 hover:shadow-lg transition-all flex items-center justify-center space-x-2 cursor-pointer"
            >
